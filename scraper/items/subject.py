...
FACULTY_PATTERN_EN = re.compile(
    r"The following (?:courses are|course is) offered by (?:the )?(.+)\."
)
FACULTY_PATTERN_FR = re.compile(
    r"Les? cours (?:suivants sont offerts|suivant est offert) par (?:la )?(.+)"
)
